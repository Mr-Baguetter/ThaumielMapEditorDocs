...
|------|------|:------:|-------------|
| [`AllowedRoles`](#allowedroles) | `List<RoleTypeId>` | `get` `set` | Gets or sets the `PlayerRoles.RoleTypeId`s that are allowed to interact with this. |
...
Gets or sets the `PlayerRoles.RoleTypeId`s that are allowed to interact with this.
